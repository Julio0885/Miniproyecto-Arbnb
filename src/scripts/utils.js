...
<div class="flex flex-col ">
        ...
        <div>
            <button id="supper" class="w-30 p-2 border border-black rounded-lg inline-block">${superHost}</button>
            ...
            <h3 id="title" class="mb-3 font-bold text-1xl text-black">${title}</h3>
        </div>
</div>
`
return template;
